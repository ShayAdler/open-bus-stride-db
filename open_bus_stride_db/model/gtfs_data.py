...
class GtfsData(Base):
    ...
    date = sqlalchemy.Column(sqlalchemy.Date, index=True, unique=True)
    download_upload_started_at = sqlalchemy.Column(DateTimeWithTimeZone, index=True)
    download_upload_completed_at = sqlalchemy.Column(DateTimeWithTimeZone)
    download_upload_error = sqlalchemy.Column(sqlalchemy.String)
    download_upload_success = sqlalchemy.Column(sqlalchemy.Boolean)
