...
def upgrade():
    ...
    op.execute("create unique index gtfs_rides_agg_by_hour_uniq_idx on gtfs_rides_agg_by_hour (gtfs_route_id, gtfs_route_date, gtfs_route_hour);")
...
def downgrade():
    ...
    op.execute("drop index gtfs_rides_agg_by_hour_uniq_idx")
